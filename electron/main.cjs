...
// --- Constants -------------------------------------------------------------
const SERVER_PORT = process.env.PORT ? parseInt(process.env.PORT, 10) : 3010;
...
function startBackend() {
  ...
  const env = {
    ...
    MYRAA_PYTHON: 'C:\\Users\\ayush\\AppData\\Local\\Programs\\Python\\Python311-arm64\\python.exe',
  };
...
function createMainWindow() {
  ...
  // Auto-approve all media/mic/camera/display permissions in Electron
