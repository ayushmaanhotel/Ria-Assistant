...
export interface MyraaSettings {
  ...
  myraaSystemPrompt: string;
  /** Optional custom file/folder path for loading Ria configuration on local system. */
  riaCustomConfigPath: string;
  /** Voice model ID for Ria (e.g. "Kore", "Fenrir", "Aoede", "Puck"). */
  riaVoice: string;
